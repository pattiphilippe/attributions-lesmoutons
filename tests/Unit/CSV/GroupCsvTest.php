...
class GroupCsvTest extends TestCase
{
    ...
    public function test_import_file_empty()
    {
        ...
        $file = UploadedFile::fake()->create('uploads/csv_import_group.csv', 24);

        $response = $this->json('POST', '/uploadFileGroup', [
            'file' => $file,
        ]);
    ...
    public function test_import_file_to_heavy()
    {
        ...
        $file = UploadedFile::fake()->create('uploads/csv_import_group.csv', 2897152);
    ...
    public function test_import_file_wrong_extension()
    {
        ...
        $file = UploadedFile::fake()->create('csv_import_group.pdf', 24);
